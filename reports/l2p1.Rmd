...
OS gráficos acima mostram a distribuição das média das avaliações em relação aos episodios de cada temporada. Com a Lenda de Aang percebemos uma variação maior dos valores, mas sem números muitos baixos. Jã com a Lenda de Korra temos menos variação, com um comportamento quase constante, mas temos no meio da quarta temporada um episódio com média muito menor que os outros. Outra característica que podemos observar é que os últimos episodios da Lenda de Aang sempre tem uma média maior que os demais e isso não é observado com a Lenda de Korra, onde por exemplo, no meio da segunda temporada temos um aumento nas médias em relação ao restante da temporada.
